...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Dialogedit_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 29, 20) // "on_Cancelbtn_clicked"
    ...
    "Dialogedit\0on_OKbtn_clicked\0\0"
...
const QMetaObject Dialogedit::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Dialogedit.data,
      qt_meta_data_Dialogedit,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Dialogedit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Dialogedit.stringdata))
